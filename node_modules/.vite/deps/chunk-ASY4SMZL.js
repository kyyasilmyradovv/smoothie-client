...
var LayoutContext = React13.createContext({
  siderHook: {
    addSider: () => null,
    removeSider: () => null
  }
...
var sider_default = genStyleHooks(["Layout", "Sider"], (token) => ({
...
var SiderContext = React14.createContext({});
...
var Sider = React14.forwardRef((props, ref) => {
  const {
  ...
  const {
    siderHook
  } = (0, import_react7.useContext)(LayoutContext);
  const [collapsed, setCollapsed] = (0, import_react7.useState)("collapsed" in props ? props.collapsed : defaultCollapsed);
  const [below, setBelow] = (0, import_react7.useState)(false);
  ...
  const responsiveHandlerRef = (0, import_react7.useRef)(null);
  ...
  const renderSider = () => {
    ...
    const zeroWidthTrigger = parseFloat(String(collapsedWidth || 0)) === 0 ? React14.createElement("span", {
      onClick: toggle,
    ...
    }, trigger || React14.createElement(BarsOutlined_default, null)) : null;
    const iconObj = {
      expanded: reverseArrow ? React14.createElement(RightOutlined_default, null) : React14.createElement(LeftOutlined_default, null),
      collapsed: reverseArrow ? React14.createElement(LeftOutlined_default, null) : React14.createElement(RightOutlined_default, null)
    };
    const status = collapsed ? "collapsed" : "expanded";
    const defaultTrigger = iconObj[status];
    const triggerDom = trigger !== null ? zeroWidthTrigger || React14.createElement("div", {
    ...
    return React14.createElement("aside", Object.assign({
      className: siderCls
    }, divProps, {
      style: divStyle,
      ref
  ...
  return wrapCSSVar(React14.createElement(SiderContext.Provider, {
    value: contextValue
  }, renderSider()));
});
if (true) {
...
//# sourceMappingURL=chunk-ASY4SMZL.js.map
